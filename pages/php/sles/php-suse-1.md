...
> In this section, you will get SQL Server 2017 running on SUSE Linux Enterprise Server. After that you will install the necessary dependencies to create PHP apps with SQL Server
