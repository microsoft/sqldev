...
> In this section you will get SQL Server Developer edition running on Windows. After that you will install the necessary dependencies to create .NET Framework apps with SQL Server.
